...
<h1 className='text-xl text-green-500 font-bold'>How will you improve the performance of a React Application?</h1>
            ...
            <h1 className='text-xl text-green-500 font-bold'> What are the different ways to manage a state in a React application?</h1>
            <p>The purpose of building the application with components is to have a modular architecture, with a clear separation of concerns. This makes code easier to understand, easier to maintain, and easier to reuse when possible.
                ...
                <h1 className='text-xl text-green-500 font-bold'> How does prototypical inheritance work?</h1>
                <p>
                ...
                <h1 className='text-xl text-green-500 font-bold'> What is a unit test? Why should write unit tests?</h1>
